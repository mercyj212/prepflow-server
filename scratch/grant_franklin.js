...
async function grantFranklinAccess() {
  try {
    await mongoose.connect(process.env.MONGODB_URI);
    console.log("Connected to MongoDB...");

    const targetEmail = "franklinpeter2020@gmail.com";
    ...
    if (!student) {
      ...
      student = await Student.create({
        fullName: "Franklin Peter",
        email: targetEmail,
        password: "Password123@", // Temporary default password if account is new
        isVerified: true
      });
